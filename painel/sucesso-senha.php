...
.box-senha input[type=submit]{
	...
	<div class = "box-senha">
		...
		<h2>A Senha foi redefinida com sucesso!</h2>
		<br/>
 		<h3>CLIQUE<a href="INCLUDE_PATH_PAINEL?>?loggout"><span> AQUI</span> </a>PARA FAZER O LOGIN :)</h3>
 		<br/>
 		<?php echo "<h3>SUA SENHA AGORA É: " .$password."</h3>";?>
