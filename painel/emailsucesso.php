...
<body>
	...
	<div class = "box-login">
		...
		<h2>Link para recadastro da senha enviado com sucesso</h2>
		<code style="color:red;">Caso não tenha recebido o e-mail, verifique o seu lixo eletrônico
e marque como <b>não é spam.</b> Qualquer dúvida entre em contato conosco.</code>
	</div><!--box-login-->
